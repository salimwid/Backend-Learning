...
class Login_model extends CI_Model{
    ...
    public function validate(){
        // grab user input
        $salt = $this->db->query('SELECT salt FROM user_login WHERE userID LIKE "'.$userID.'%"')->result_array();
		// hash the password
		...
		$query = $this->db->query("SELECT * FROM user_login WHERE user_name = '".$postData['user_name']."' AND password = '".$password."'")->result_array();
